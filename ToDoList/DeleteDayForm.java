...
public class DeleteDayForm  implements ActionListener{
	...
	public void actionPerformed(ActionEvent ae) {
		if(ae.getActionCommand().equals("yes")){
			try {
				...
				String query = "delete from day_task where task_date ="+"'"+TodayTask.dat+"'";
				st.executeUpdate(query);
				query = "delete from day where task_date ="+"'"+TodayTask.dat+"'";
				st.executeUpdate(query);
